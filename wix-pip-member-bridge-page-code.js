...
const PIP_HTML_SRC = "https://hydropip-pip-api.onrender.com/pip.html?v=launch-20260809-flow2";
...
function buildPipSource() {
  const forwarded = ["pro", "project", "projectId", "return", "start", "tool", "focus", "avatar", "prompt"]
    .map((key) => {
