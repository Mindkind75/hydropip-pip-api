(function(){
  ...
  window.HydroPipPestWatch={render(root,data,{memberId,projectId,onRecord}={}){
    ...
    const crops=el('button','Update current crops','btn');crops.type='button';crops.addEventListener('click',()=>document.querySelector('[data-pro-page="seeds"]')?.click());coverage.append(crops);root.append(coverage);
