...
app.get('/api/pip/projects/:projectId/history',async(req,res,next)=>{try{res.json(await messagePage({userId:req.pipUser.id,projectId:req.params.projectId,conversationId:req.query.conversationId,query:req.query.q,around:req.query.around,before:req.query.before,limit:req.query.limit,includeArchived:req.query.archived==='1'}))}catch(error){next(error)}});
