...
const cases = [
  ...
  { q: "Do I need to start seedlings separately before planting HydroPip?", type: "free", must: ["Direct", "50/50", "optional"], avoid: ["must use starter", "Pip Pro"] },
  { q: "Can I sow lettuce seeds straight into the tower pots?", type: "free", must: ["direct", "perlite", "vermiculite"], avoid: ["must start separately", "Pip Pro"] },
  { q: "Should I use starter plugs for tomatoes?", type: "free", must: ["optional", "tomato"], avoid: ["required", "Pip Pro"] },
  { q: "When I reset the towers, should every mature plant go into my raised beds?", type: "free", must: ["healthy", "productive", "raised"], avoid: ["every plant", "Pip Pro"] },
